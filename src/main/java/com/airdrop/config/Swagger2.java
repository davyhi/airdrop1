...
//            add(new ResponseMessageBuilder().code(-1).message("未知异常").responseModel(new ModelRef("Error")).build());
        ...
        ticketPar.name(TokenUtil.TOKEN).description("请求携带的token")//name表示名称，description表示描述
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.airdrop.controller"))
