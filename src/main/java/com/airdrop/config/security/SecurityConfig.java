...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/swagger-ui.html", "/logout", "/v2/api-docs", "/webjars/**", "/swagger-resources/**", "/login", "/favicon.ico","/registerPhone","/registerEmail","/getcode","/getcode1","/saveUserCount","/saveCount","/findCount","/findBalance","/findSpecialBalance","/checkPhoneExist","/checkEmailExist","/checkUserCount");
    }
